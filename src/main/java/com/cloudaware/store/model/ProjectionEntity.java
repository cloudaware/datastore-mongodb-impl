...
public final class ProjectionEntity extends BaseEntity<Key> {
    ...
    ProjectionEntity(final Builder builder) {
        super(builder);
    }
    ...
    public static Builder newBuilder(final ProjectionEntity copyFrom) {
...
//    }
    ...
    public static final class Builder extends BaseEntity.Builder<Key, Builder> {
        ...
        private Builder(final ProjectionEntity entity) {
            super(entity);
        }
