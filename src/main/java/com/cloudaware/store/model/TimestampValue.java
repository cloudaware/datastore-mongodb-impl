...
public final class TimestampValue extends Value<Timestamp> {
    ...
    public TimestampValue(final Timestamp timestamp) {
        this(newBuilder(timestamp));
    }

    private TimestampValue(final Builder builder) {
        super(builder);
    }

    public static TimestampValue of(final Timestamp timestamp) {
        return new TimestampValue(timestamp);
    }

    public static Builder newBuilder(final Timestamp timestamp) {
