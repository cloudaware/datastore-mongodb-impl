...
public final class ProjectionEntityQuery extends StructuredQuery<ProjectionEntity> {
    ...
    ProjectionEntityQuery(final Builder builder) {
        super(builder);
    }
    ...
    public static final class Builder extends StructuredQuery.BuilderImpl<ProjectionEntity, Builder> {
        ...
        Builder(final ProjectionEntityQuery query) {
            super(query);
        }
         ...
         */
        @Override
        public Builder setProjection(final String projection, final String... others) {
         ...
         */
        @Override
        public Builder addProjection(final String projection, final String... others) {
         ...
         */
        @Override
        public Builder setDistinctOn(final String property, final String... others) {
         ...
         */
        @Override
        public Builder addDistinctOn(final String property, final String... others) {
