...
final class Validator {
    ...
    static String validateDatabase(final String projectId) {
    ...
    static String validateNamespace(final String namespace) {
    ...
    static String validateKind(final String kind) {
